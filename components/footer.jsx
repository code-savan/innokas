  ...
  return (
    ...
    <div className="max-w-7xl mx-auto px-4">
      <div className="grid md:grid-cols-4 gap-8">
        <div>
            <Image src={"/darklogot.png"} alt='footer logo' width={100} height={100} />
          <h3 className="text-xl font-bold mb-4">Innokas Nigeria</h3>
        ...
        <div>
          ...
          <ul className="space-y-2 text-gray-400">
            <li>Location: 16, Cause Way Road, Saka Alao Street, Ijora 7up, Lagos State.</li>
            <li>Phone:  <span>
      ...
      <div className="border-t border-gray-800 mt-12 pt-8 text-center text-white/90">
        <p>&copy; {new Date().getFullYear()} Innokas Nigeria Limited. All rights reserved.</p>
      </div>
    </div>
  </footer>
  )
